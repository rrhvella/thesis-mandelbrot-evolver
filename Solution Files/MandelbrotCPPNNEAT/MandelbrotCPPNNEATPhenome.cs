...
namespace MandelbrotCPPNNEAT
{
    public class MandelbrotCPPNNEATPhenome 
    {
        ...
        /// </summary>
        /// <param name="viewResolutionWidth">The resolution width, in pixels, of the fractal views. Resolution here refers to 
        /// the number of complex numbers sampled within a view.</param>
        /// <param name="viewResolutionHeight">The resolution height, in pixels, of the fractal views. Resolution here refers to 
        /// the number of complex numbers sampled within a view.</param>
        ...
        /// number limit.
        /// </summary>
        /// <param name="viewWidthResolution"></param>
        /// <param name="viewHeightResolution"></param>
